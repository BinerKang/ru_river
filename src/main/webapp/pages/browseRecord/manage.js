...
module.exports = {
	...
	methods: {
		...
		loadPage: function() {
			...
			Najax.post('browseRecord/getBrowseRecordsCount', params).then(function(res){
		...
		initPage: function initPagination() {
			...
			function pageselectCallback(page_index) {
				...
				Najax.post('browseRecord/getBrowseRecords', params).then(function(res){
					self.totalData = res.result.data.browseRecords;
				}).catch(function(error){
					console.log(error);
				});
				return false;
